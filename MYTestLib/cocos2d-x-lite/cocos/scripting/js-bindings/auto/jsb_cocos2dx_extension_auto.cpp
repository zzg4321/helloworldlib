...
static bool js_extension_AssetsManagerEx_setLocalManifestUrl(se::State& s)
{
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_AssetsManagerEx_setLocalManifestUrl : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_extension_AssetsManagerEx_setLocalManifestUrl : Error processing arguments");
        cobj->setLocalManifestUrl(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_extension_AssetsManagerEx_setLocalManifestUrl)
...
static bool js_extension_AssetsManagerEx_setRomotePackageUrl(se::State& s)
{
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_extension_AssetsManagerEx_setRomotePackageUrl : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_extension_AssetsManagerEx_setRomotePackageUrl : Error processing arguments");
        cobj->setRomotePackageUrl(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_extension_AssetsManagerEx_setRomotePackageUrl)
...
static bool js_extension_AssetsManagerEx_constructor(se::State& s)
{
    ...
    do {
        if (argc == 4) {
            ...
            ok &= seval_to_std_string(args[2], &arg2);
            if (!ok) { ok = true; break; }
            std::function<int (const std::string&, const std::string&)> arg3;
            do {
            ...
            ;
            if (!ok) { ok = true; break; }
            cocos2d::extension::AssetsManagerEx* cobj = new (std::nothrow) cocos2d::extension::AssetsManagerEx(arg0, arg1, arg2, arg3);
            s.thisObject()->setPrivateData(cobj);
            return true;
        }
    } while(false);
...
bool js_register_extension_AssetsManagerEx(se::Object* obj)
{
    ...
    cls->defineFunction("setLocalManifestUrl", _SE(js_extension_AssetsManagerEx_setLocalManifestUrl));
    ...
    cls->defineFunction("setRomotePackageUrl", _SE(js_extension_AssetsManagerEx_setRomotePackageUrl));
